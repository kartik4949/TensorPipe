...
# from loaders import reader as read  # pylint: disable=import-error
# from loders import decoder  # pylint: disable=import-error
...
class CategoricalTensorFunnel(Funnel):
    ...
    # TODO (HIGH) Make it working for categorical
